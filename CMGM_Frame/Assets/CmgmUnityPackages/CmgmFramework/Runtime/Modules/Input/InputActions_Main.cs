...
//     version 1.19.0
//     from Assets/CmgmUnityPackages/CmgmFramework/Runtime/Modules/Input/InputActions_Main.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/CmgmUnityPackages/CmgmFramework/Runtime/Modules/Input/InputActions_Main.inputactions".
    /// </summary>
    /// <remarks>
    ...
    ""controlSchemes"": [
        ...
        ~@InputActions_Main()
        {
            UnityEngine.Debug.Assert(!m_GamePlay.enabled, "This will cause a leak and performance issues, InputActions_Main.GamePlay.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, InputActions_Main.UI.Disable() has not been called.");
        }
